...
```json
{
  "mcpServers": {
    "playwright-enhanced": {
      "command": "/Users/Chen/Coding/mcp/playwright-mcp/start-enhanced.sh"
    }
  }
}
```
...
```bash
node /Users/Chen/Coding/mcp/playwright-mcp/cli.js \
  --browser chrome \
  --init-page /Users/Chen/Coding/mcp/playwright-mcp/init-page-enhanced.ts \
  --timeout-action 5000 \
